...
?>
    ...
    <title>Trek & Drone | Inscription</title>
 
</head>
<body>
<header><div id="navResp">
...
<?php
    ...
    {
?>
    <form id="newsform" method="post" action="inscription.php?tru=2">
        <div style="margin: 10px auto">
            <h1 style="text-align: center;">Validation de votre inscription à la Newsletter : </h1>
        </div>
        <div style="margin: 10px auto">
...
elseif($_GET['tru']==2) // Sinon, si la variable $_GET['tru'] est égale à 2.
    ...
    global $con;
        ...
        try {
            ...
            $stt = $con->prepare("INSERT INTO newsletter (email) VALUES (:email)");
        ...
        echo "<div class='errornewsmess'><h2>Inscription à la Newsletter : </h2><span style='margin-bottom: 15px'>Vous avez bien été inscrit à la newsletter de Trekandrone.com ! Vous allez être redirigé dans 1 seconde.</span></div><img id='shadowerrors' class='shadow' src='img/shadow.png' alt='ombre'>";
 
        }
        else
        {
 
        echo "<div class='errornewsmess'><h2>Inscription à la Newsletter : </h2><span style='margin-bottom: 15px'>Vous n'avez pas entré la bonne adresse e-mail !</span></div><img id='shadowerrors' class='shadow' src='img/shadow.png' alt='ombre'>";
 
        }
    }
    else
    {
echo "<div class='errornewsmess'><h2>Inscription à la Newsletter : </h2><span style='margin-bottom: 15px'>Il y a eu une erreur.</span></div><img id='shadowerrors' class='shadow' src='img/shadow.png' alt='ombre'>";
    }
