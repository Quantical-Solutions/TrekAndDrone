...
<body>
	...
	<main id="maincon" class="maindecon">
		<div id="formcon" class="formdecon">
			<h1>Adresse IP débannie</h1>
            <p>Vous venez de débannir une adresse IP dont l'activité a été considérée comme pouvant compromettre la sécurité de la partie "Gestion" du site <br><span style="color: black;">Trek & Drone</span><br><a href="http://www.trekandrone.com/gestion-administrateur">Reconnectez vous</a><br>pour poursuivre la gestion.</p>
		</div>
		<div id="logorot">
