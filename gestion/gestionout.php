...
<head>
	<meta charset="utf-8">
	<title>Trek & Drone | Déconnecté</title>
...
<body>
	<main id="maincon" class="maindecon">
		<div id="formcon" class="formdecon">
			<h1>A bientôt !</h1>
			<p>Vous venez de vous déconnecter de la section <i>Gestion</i><br>du site<a href="http://www.trekandrone.com">Trek & Drone</a>.<br>Vous pouvez vous reconnecter en cliquant <a href="http://www.trekandrone.com/gestion-administrateur">ICI</a>.</p>
			<p>
		</div>
		<div id="logorot">
