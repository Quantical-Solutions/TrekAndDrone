...
<body>
	...
	<main id="maincon" class="maindecon">
		<div id="formcon" class="formdecon">
			<h1>Newsletter envoyée</h1>
			<p>Vous venez d'envoyer une nouvelle<br><span style="color: black;">Newsletter</span>.<br><a href="http://www.trekandrone.com/gestion-administrateur">Reconnectez vous</a><br>pour poursuivre la gestion.</p>
		</div>
		<div id="logorot">
