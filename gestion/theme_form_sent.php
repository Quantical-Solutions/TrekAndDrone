...
<body>
	...
	<main id="maincon" class="maindecon">
		<div id="formcon" class="formdecon">
			<h1>Thème chargé</h1>
			<p>Vous venez de changer<br><i>le Thème</i><br>de votre tableau de bord.<br><a href="http://www.trekandrone.com/gestion-administrateur">Retour</a> à la partie <i>Gestion</i>.</p>
		</div>
		<div id="logorot">
