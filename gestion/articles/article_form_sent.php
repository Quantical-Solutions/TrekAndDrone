...
<body>
	...
	<main id="maincon" class="maindecon">
		<div id="formcon" class="formdecon">
			<h1>Changements enregistrés</h1>
			<p>L' édition ou modification de votre article a bien été enregistrée.<br><a href="http://www.trekandrone.com/gestion-administrateur">Retour</a><br>à la partie <i>Gestion</i> pour vous<br>reconnecter ou bien<br><a href="http://www.trekandrone.com/deconnexion">ICI</a><br>pour vous déconnecter.</p>
		</div>
		<div id="logorot">
