<?php require('includes/header.php'); ?>
	...
	<main id="cgu">
		<h1>Conditions générales d'utilisation du site <a href="http://www.trekandrone.com"> Treckandrone.com</a></h1>

<h2>ARTICLE 1 : Objet</h2>

<p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site <a href="http://www.trekandrone.com"> Treckandrone.com</a> et leur utilisation par « l'Utilisateur ».</p>
...
<p><a href="http://www.trekandrone.com"> Treckandrone.com</a> se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.</p>

<h2>ARTICLE 2 : Mentions légales</h2>

<p>L'édition du site <a href="http://www.trekandrone.com"> Treckandrone.com</a> est assurée par la Société Dee Web, dont le siège social est situé au 35 rue Jean Claudeville, 33520 Bruges.</p>
<p>Le Directeur de la publication est Monsieur Frédéric Geffray.</p>

<p>L'hébergeur du site <a href="http://www.trekandrone.com"> Treckandrone.com</a> est la Société OVH SAS au capital de 10 069 020 €, RCS Lille Métropole 424 761 419 00045, dont le siège social est au 2 rue Kellermann - 59100 Roubaix - France.</p>
...
<li><p>Identifiant et mot de passe : c'est l'ensemble des informations nécessaires à l'identification d'un Utilisateur sur le site. L'identifiant et le mot de passe permettent à l'Utilisateur d'accéder à des services réservés aux membres du site. Le mot de passe est confidentiel.</p></li></ul>

<h2>ARTICLE 4 : Accès aux services</h2>

<p>Le site permet à l'Utilisateur un accès gratuit aux articles d’information.</p>
...
<p>Le site met en œuvre tous les moyens mis à sa disposition pour assurer un accès de qualité à ses services. L'obligation étant de moyens, le site ne s'engage pas à atteindre ce résultat.
Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de <a href="http://www.trekandrone.com"> Treckandrone.com</a>.</p>
...
L'Utilisateur a la possibilité de contacter le site par la page <a href="http://www.trekandrone.com/contact">contact</a> du site.</p>
...
<p>En vertu des articles 39 et 40 de la loi en date du 6 janvier 1978, l'Utilisateur dispose d'un droit d'accès, de rectification, de suppression et d'opposition de ses données personnelles. L'Utilisateur exerce ce droit via la page <a href="http://www.trekandrone.com/contact">contact</a> du site.</p>
...
Une garantie optimale de la sécurité et de la confidentialité des données transmises n'est pas assurée par le site. Toutefois, le site s'engage à mettre en œuvre tous les moyens nécessaires afin de garantir au mieux la sécurité et la confidentialité des données.</p>
...
<p>De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de <a href="http://www.trekandrone.com"> Treckandrone.com</a> qui n'a pas le contrôle de ces liens.</p>
...
<p>La législation française s'applique au présent contrat. En cas d'absence de résolution amiable d'un litige né entre les parties, seuls les tribunaux du ressort de la Cour d'appel la ville de Bordeaux sont compétents.</p>
	</main>
